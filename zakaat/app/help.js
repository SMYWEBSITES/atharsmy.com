...
(function (global) {
  ...
  const S = {
    ...
    nav_backup: { en: "Backup & Restore", ur: "بیک اپ و بحالی", hi: "बैकअप और रीस्टोर", ar: "نسخ احتياطي واستعادة",
      bn: "ব্যাকআপ ও পুনরুদ্ধার",
      id: "Cadangan & Pulihkan",
      tr: "Yedek & Geri Yükle",
    ...
    // --- Backup tab strings ---
    bkp_title:          { en: "Backup",                   ur: "بیک اپ",               hi: "बैकअप",                ar: "نسخ احتياطي",         bn: "ব্যাকআপ",            id: "Cadangan",             tr: "Yedek",                  fr: "Sauvegarde" },
    bkp_download_device:{ en: "Download to device",       ur: "ڈیوائس پر ڈاؤن لوڈ",  hi: "डिवाइस पर डाउनलोड",   ar: "تنزيل على الجهاز",    bn: "ডিভাইসে ডাউনলোড",   id: "Unduh ke perangkat",   tr: "Cihaza indir",           fr: "Télécharger sur l'appareil" },
    bkp_download_report:{ en: "Download report",          ur: "رپورٹ ڈاؤن لوڈ",       hi: "रिपोर्ट डाउनलोड",     ar: "تنزيل التقرير",       bn: "রিপোর্ট ডাউনলোড",   id: "Unduh laporan",        tr: "Raporu indir",           fr: "Télécharger le rapport" },
    bkp_drive_label:    { en: "Google Drive",             ur: "گوگل ڈرائیو",          hi: "Google Drive",          ar: "Google Drive",        bn: "Google Drive",       id: "Google Drive",         tr: "Google Drive",           fr: "Google Drive" },
    bkp_not_connected:  { en: "Not connected",            ur: "جڑا نہیں",             hi: "कनेक्ट नहीं",          ar: "غير متصل",            bn: "সংযুক্ত নয়",        id: "Tidak terhubung",      tr: "Bağlı değil",            fr: "Non connecté" },
    bkp_connect:        { en: "Connect Google Drive",     ur: "گوگل ڈرائیو سے جوڑیں", hi: "Google Drive से जोड़ें", ar: "ربط Google Drive",   bn: "Google Drive যুক্ত করুন", id: "Hubungkan Google Drive", tr: "Google Drive'a bağlan", fr: "Connecter Google Drive" },
    bkp_reconnect:      { en: "Reconnect Google Drive",   ur: "دوبارہ جوڑیں",         hi: "फिर से जोड़ें",        ar: "إعادة الربط",         bn: "পুনরায় সংযুক্ত করুন", id: "Hubungkan ulang",    tr: "Yeniden bağlan",         fr: "Reconnecter" },
    bkp_upload_now:     { en: "Upload now",               ur: "ابھی اپلوڈ کریں",      hi: "अभी अपलोड करें",       ar: "رفع الآن",            bn: "এখনই আপলোড করুন",   id: "Unggah sekarang",      tr: "Şimdi yükle",            fr: "Téléverser maintenant" },
    bkp_auto_save:      { en: "Auto-save",                ur: "خودکار محفوظ",         hi: "स्वतः सहेजें",         ar: "حفظ تلقائي",          bn: "স্বতঃ-সংরক্ষণ",    id: "Simpan otomatis",      tr: "Otomatik kaydet",        fr: "Enreg. auto" },
    bkp_disconnect:     { en: "Disconnect",               ur: "منقطع کریں",           hi: "डिस्कनेक्ट करें",      ar: "قطع الاتصال",         bn: "সংযোগ বিচ্ছিন্ন",   id: "Putuskan",             tr: "Bağlantıyı kes",         fr: "Déconnecter" },
    bkp_drive_setup:    { en: "Google Cloud setup",       ur: "گوگل کلاؤڈ سیٹ اپ",   hi: "Google Cloud सेटअप",   ar: "إعداد Google Cloud",  bn: "Google Cloud সেটআপ", id: "Pengaturan Google Cloud", tr: "Google Cloud kurulumu", fr: "Config. Google Cloud" },
    bkp_restore_title:  { en: "Restore",                  ur: "بحال کریں",            hi: "पुनर्स्थापित करें",    ar: "استعادة",             bn: "পুনরুদ্ধার",         id: "Pulihkan",             tr: "Geri yükle",             fr: "Restaurer" },
    bkp_from_excel:     { en: "From Excel file",          ur: "ایکسل فائل سے",        hi: "Excel फ़ाइल से",        ar: "من ملف Excel",        bn: "Excel ফাইল থেকে",    id: "Dari file Excel",      tr: "Excel dosyasından",      fr: "Depuis Excel" },
    bkp_from_drive:     { en: "From Google Drive",        ur: "گوگل ڈرائیو سے",       hi: "Google Drive से",       ar: "من Google Drive",     bn: "Google Drive থেকে",  id: "Dari Google Drive",    tr: "Google Drive'dan",       fr: "Depuis Google Drive" },
    bkp_clear:          { en: "Clear all data…",     ur: "تمام ڈیٹا حذف…",  hi: "सभी डेटा हटाएं…", ar: "مسح البيانات…",  bn: "সব ডেটা মুছুন…", id: "Hapus semua…",  tr: "Tümünü temizle…",   fr: "Tout effacer…" },
    ...
    // ── Guide / About tab ──────────────────────────────────────────────────────
    guide_learn:       { en: "Learn about Zakat",          ur: "زکات کے بارے میں جانیں",    hi: "ज़कात के बारे में जानें",    ar: "تعرّف على الزكاة",          bn: "জাকাত সম্পর্কে জানুন",    id: "Pelajari tentang Zakat",   tr: "Zekat Hakkında Bilgi",       fr: "En savoir sur la Zakat" },
    guide_tab_about:   { en: "About Zakat",                ur: "زکات کیا ہے",               hi: "ज़कात क्या है",              ar: "ما هي الزكاة",              bn: "জাকাত কী",                 id: "Tentang Zakat",            tr: "Zekat Nedir",                fr: "Qu'est-ce que la Zakat" },
    guide_tab_faq:     { en: "FAQ",                        ur: "عام سوالات",                hi: "सामान्य प्रश्न",             ar: "الأسئلة الشائعة",           bn: "সাধারণ প্রশ্ন",            id: "FAQ",                      tr: "Sık Sorulan Sorular",        fr: "FAQ" },
    guide_expand_all:  { en: "Expand all",                 ur: "سب کھولیں",                 hi: "सब खोलें",                  ar: "توسيع الكل",                bn: "সব প্রসারিত করুন",         id: "Perluas semua",            tr: "Tümünü genişlet",            fr: "Tout développer" },
    guide_collapse_all:{ en: "Collapse all",               ur: "سب بند کریں",               hi: "सब बंद करें",               ar: "طي الكل",                   bn: "সব সংকুচিত করুন",          id: "Ciutkan semua",            tr: "Tümünü daralt",              fr: "Tout réduire" },
    guide_cur_school:  { en: "Current school:",            ur: "منتخب مذہب:",               hi: "वर्तमान मज़हब:",             ar: "المذهب الحالي:",            bn: "বর্তমান মাযহাব:",          id: "Mazhab saat ini:",         tr: "Mevcut mezhep:",             fr: "École actuelle :" },
    guide_change_school:{ en: "(change on the Market Rates tab)", ur: "(مارکیٹ ریٹس ٹیب پر تبدیل کریں)", hi: "(मार्केट रेट्स टैब पर बदलें)", ar: "(غيّر من علامة تبويب الأسعار)", bn: "(মার্কেট রেটস ট্যাবে পরিবর্তন করুন)", id: "(ubah di tab Kurs Pasar)", tr: "(Piyasa Kurları sekmesinde değiştirin)", fr: "(changer dans l'onglet Taux)" },

    // Section titles
    guide_s_app:       { en: "About this app",             ur: "اس ایپ کے بارے میں",        hi: "इस ऐप के बारे में",          ar: "عن هذا التطبيق",            bn: "এই অ্যাপ সম্পর্কে",        id: "Tentang aplikasi ini",     tr: "Bu uygulama hakkında",       fr: "À propos de cette app" },
    guide_s_what:      { en: "What is Zakat?",             ur: "زکات کیا ہے؟",              hi: "ज़कात क्या है?",             ar: "ما هي الزكاة؟",             bn: "জাকাত কী?",                id: "Apa itu Zakat?",           tr: "Zekat nedir?",               fr: "Qu'est-ce que la Zakat ?" },
    guide_s_when:      { en: "When and how it is due",     ur: "کب اور کیسے واجب ہوتی ہے", hi: "कब और कैसे देय होता है",    ar: "متى وكيف تجب الزكاة",      bn: "কখন ও কীভাবে প্রযোজ্য",   id: "Kapan dan bagaimana zakatnya", tr: "Ne zaman ve nasıl ödenir", fr: "Quand et comment elle est due" },
    guide_s_calc:      { en: "How this app calculates",    ur: "یہ ایپ حساب کیسے کرتی ہے", hi: "यह ऐप कैसे गणना करता है",   ar: "كيف يحسب التطبيق",         bn: "অ্যাপ কীভাবে হিসাব করে",   id: "Cara aplikasi menghitung", tr: "Uygulama nasıl hesaplar",    fr: "Comment l'app calcule" },
    guide_s_schools:   { en: "Schools of thought",         ur: "فقہی مذاہب",                hi: "विचार के विद्यालय",          ar: "المذاهب الفقهية",           bn: "মাযহাবসমূহ",               id: "Mazhab fikih",             tr: "Fıkıh mezhepleri",           fr: "Écoles de pensée" },
    guide_s_using:     { en: "Using the app",              ur: "ایپ کا استعمال",             hi: "ऐप का उपयोग",               ar: "استخدام التطبيق",           bn: "অ্যাপ ব্যবহার",            id: "Menggunakan aplikasi",     tr: "Uygulamayı kullanma",        fr: "Utilisation de l'app" },
    guide_s_disclaimer:{ en: "Disclaimer",                 ur: "اہم وضاحت",                 hi: "अस्वीकरण",                  ar: "إخلاء المسؤولية",           bn: "দাবিত্যাগ",                id: "Penafian",                 tr: "Sorumluluk reddi",           fr: "Avertissement" },

    // FAQ questions
    guide_faq_q1:  { en: "Is this app a fatwa or legal advice?",             ur: "کیا یہ ایپ فتویٰ یا قانونی مشورہ ہے؟",          hi: "क्या यह ऐप फ़तवा या कानूनी सलाह है?",       ar: "هل هذا التطبيق فتوى أو نصيحة قانونية؟" },
    guide_faq_q2:  { en: "What is nisab (نصاب)?",                            ur: "نصاب کیا ہے؟",                                   hi: "निसाब (नصاب) क्या है?",                      ar: "ما هو النصاب؟" },
    guide_faq_q3:  { en: "Why does the dashboard show zero Zakat due?",      ur: "ڈیش بورڈ پر زکات کیوں صفر دکھا رہی ہے؟",       hi: "डैशबोर्ड पर शून्य ज़कात क्यों दिख रही है?", ar: "لماذا تظهر الزكاة صفرًا في لوحة التحكم؟" },
    guide_faq_q4:  { en: "Do I use purchase price or today's value?",        ur: "کیا میں خرید قیمت یا آج کی قیمت استعمال کروں؟", hi: "क्या खरीद मूल्य या आज का मूल्य उपयोग करें?", ar: "أستخدم سعر الشراء أم القيمة الحالية؟" },
    guide_faq_q5:  { en: "Do I pay Zakat on the house I live in?",           ur: "کیا اپنے رہائشی گھر پر زکات دینی ہوگی؟",        hi: "क्या रहने वाले घर पर ज़कात देनी होगी?",     ar: "هل تجب الزكاة على المنزل الذي أسكنه؟" },
    guide_faq_q6:  { en: "I have two houses — what do I enter?",             ur: "میرے پاس دو گھر ہیں — کیا درج کروں؟",           hi: "मेरे पास दो घर हैं — क्या दर्ज करें?",      ar: "لديّ منزلان — ماذا أدخل؟" },
    guide_faq_q7:  { en: "Trade property held for years — which value?",     ur: "سالوں سے رکھی تجارتی جائیداد — کون سی قیمت؟",   hi: "सालों से रखी ट्रेड प्रॉपर्टी — कौन सा मूल्य?", ar: "عقار تجاري محتفظ به منذ سنوات — أي قيمة؟" },
    guide_faq_q8:  { en: "What is hawl and when do I set 'Hawl start'?",     ur: "حول کیا ہے اور حول آغاز کب مقرر کروں؟",        hi: "हौल क्या है और हौल स्टार्ट कब सेट करें?",  ar: "ما هو الحول ومتى أضبط بداية الحول؟" },
    guide_faq_q9:  { en: "When should I calculate and pay Zakat?",           ur: "زکات کا حساب اور ادائیگی کب کروں؟",             hi: "ज़कात की गणना और भुगतान कब करें?",          ar: "متى أحسب الزكاة وأدفعها؟" },
    guide_faq_q10: { en: "Is Zakat on cash or rent monthly or yearly?",      ur: "نقدی یا کرایے پر زکات ماہانہ ہے یا سالانہ؟",   hi: "नकद या किराए पर ज़कात मासिक है या वार्षिक?", ar: "هل زكاة النقد والإيجار شهرية أم سنوية؟" },
    guide_faq_q11: { en: "Is gold jewellery zakatable?",                     ur: "کیا سونے کے زیورات پر زکات واجب ہے؟",           hi: "क्या सोने के गहनों पर ज़कात देय है?",       ar: "هل تجب الزكاة على الذهب المصاغ؟" },
    guide_faq_q12: { en: "What is rikaz and how is it different from savings?", ur: "رکاز کیا ہے اور بچت سے کیسے مختلف ہے؟",     hi: "रिकाज़ क्या है और बचत से कैसे अलग है?",    ar: "ما هو الركاز وكيف يختلف عن المدخرات؟" },
    guide_faq_q13: { en: "Difference between Zakat, sadaqah, and Zakat al-Fitr?", ur: "زکات، صدقہ، اور زکات الفطر میں کیا فرق ہے؟", hi: "ज़कात, सदक़ह और ज़कात-उल-फ़ित्र में क्या अंतर है?", ar: "ما الفرق بين الزكاة والصدقة وزكاة الفطر؟" },
    guide_faq_q14: { en: "How does the app handle loans and debts?",          ur: "ایپ قرضوں اور ذمہ داریوں کو کیسے سنبھالتی ہے؟", hi: "ऐप कर्ज़ और देनदारियाँ कैसे संभालता है?", ar: "كيف يتعامل التطبيق مع القروض والديون؟" },
    guide_faq_q15: { en: "Do I pay on my salary or on what is still in the bank?", ur: "کیا تنخواہ پر زکات ہے یا بینک میں باقی رقم پر؟", hi: "वेतन पर ज़कात है या बैंक में बची राशि पर?", ar: "هل أزكي على راتبي أم على ما تبقى في البنك؟" },
    guide_faq_q16: { en: "What about PF, EPF, mutual funds, and shares?",    ur: "PF، EPF، میوچوئل فنڈز، اور اسٹاکس کے بارے میں؟", hi: "PF, EPF, म्यूचुअल फंड और शेयरों के बारे में?", ar: "ماذا عن صناديق التقاعد والأسهم؟" },
    guide_faq_q17: { en: "I missed Zakat for previous years — does the app catch up?", ur: "پچھلے سالوں کی زکات رہ گئی — کیا ایپ اسے درست کرتی ہے؟", hi: "पिछले सालों की ज़कात छूट गई — क्या ऐप उसे ट्रैक करता है?", ar: "فاتتني زكاة سنوات ماضية — هل يعوّضها التطبيق؟" },
    guide_faq_q18: { en: "How do I record what I already paid?",              ur: "میں نے جو پہلے ادا کیا وہ کیسے ریکارڈ کروں؟",   hi: "पहले भुगतान की गई राशि कैसे रिकॉर्ड करें?", ar: "كيف أسجل ما دفعته مسبقًا؟" },
    guide_faq_q19: { en: "Who can receive my Zakat?",                        ur: "میری زکات کون لے سکتا ہے؟",                     hi: "मेरी ज़कात कौन प्राप्त कर सकता है?",         ar: "من يحق له استلام زكاتي؟" },
    guide_faq_q20: { en: "Why does Hanafi nisab differ from other calculators?", ur: "حنفی نصاب دوسرے کیلکولیٹرز سے مختلف کیوں ہے؟", hi: "हनफ़ी निसाब अन्य कैलकुलेटरों से अलग क्यों है?", ar: "لماذا يختلف نصاب الحنفية عن الآلات الأخرى؟" },
    guide_faq_q21: { en: "How do I open or back up my data?",                ur: "اپنا ڈیٹا کیسے کھولوں یا بیک اپ کروں؟",        hi: "अपना डेटा कैसे खोलें या बैकअप लें?",        ar: "كيف أفتح بياناتي أو أحتفظ بنسخة احتياطية؟" },
    guide_faq_q22: { en: "Why are Analytics charts empty for cash or property?", ur: "اینالیٹکس چارٹ نقدی یا جائیداد کے لیے خالی کیوں ہیں؟", hi: "एनालिटिक्स चार्ट नकद या प्रॉपर्टी के लिए खाली क्यों हैं?", ar: "لماذا مخططات التحليلات فارغة للنقد أو العقارات؟" },
    guide_faq_q23: { en: "Can I track the whole family?",                    ur: "کیا میں پورے خاندان کا ریکارڈ رکھ سکتا ہوں؟",   hi: "क्या मैं पूरे परिवार को ट्रैक कर सकता हूँ?",ar: "هل يمكنني متابعة الأسرة كاملة؟" },
  };
